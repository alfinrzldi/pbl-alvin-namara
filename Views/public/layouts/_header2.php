<nav class=" w-full z-50 top-0 start-0">
    ...
    <div class="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
      ...
      <a href="<?= isset($_SESSION['role_user']) ? '/profile' : '/login' ?>">
       ...
       <a href="<?= isset($_SESSION['role_user']) ? '/logout' : '/login' ?>">
        <button type="button" class="text-button font-bold bg-gray-800 hover:bg-gray-800 hover:text-black hover:duration-500 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg text-sm px-4 py-2 text-center"><?= isset($_SESSION['role_user']) ? 'Logout' : 'Login   ' ?></button> </a>
    ...
    <div class="items-end justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
      <ul class="flex flex-col p-4 md:p-0 mt-4 font-medium border rounded-lg md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0">
        ...
        <li>
          <a href="/" class="block py-2 px-3 text-black rounded md:hover:rounded-xl md:hover:text-blue-700 md:p-2 lg:p-2">Category</a>
        </li>
        <li>
          <a href="/" class="block py-2 px-3 text-black rounded md:hover:rounded-xl md:hover:text-blue-700 md:p-2 lg:p-2">Produk</a>
        </li>
        <li>
