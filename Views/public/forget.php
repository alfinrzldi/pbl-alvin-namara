...
<div class="bg-yellow-300 rounded-3xl shadow-lg p-8 w-[80%] lg:w-1/3">
        ...
        <form action="/registerUser" class="space-y-6" method="POST">
            <div>
                ...
                <input class="text-white w-full px-4 py-2 rounded-lg border bg-gray-800 border-gray-400" id="email" name="email" placeholder="Email"
                   required type="email">
            </div>
            <div>
                <label class="block text-gray-900 font-regular  mb-2" for="username" >
                ...
                <input class="text-white w-full px-4 py-2 rounded-lg border bg-gray-800 border-gray-400" id="username" name="username" placeholder="Username"
            ...
            <div>
                ...
                <input class="w-full text-white px-4 py-2 rounded-lg border bg-gray-800 border-gray-400" id="password" name="password" 
            ...
            <div>
                ...
                <input class="w-full px-4 py-2 text-white rounded-lg border bg-gray-800 border-gray-400" id="password2" name="password2"
                    required type="password" placeholder="Konfirmasi Password" >
            </div>
